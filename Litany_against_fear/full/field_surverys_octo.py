...
birds = [
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Alternate_Eastern_Towhee.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_American_Goldfinch.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_American_Robin.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Black_Capped_Chickadee.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Blue_Jay.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Brown_Headed_Cowbird.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Downy_Woodpecker.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Eastern_Bluebird.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Eastern_Towhee.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Eastern_Wood_Pewee.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Hairy_Woodpecker-44k.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Hairy_Woodpecker.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_House_Sparrow.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Indigo_Bunting.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Mourning_Dove.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Northern_Cardinal.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Pileated_Woodpecker.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Red_Bellied_Woodpecker.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Ruby_Throated_Hummingbird.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_Tufted_Titmouse.wav',
    '/Users/evansdsg2/supercollider_scores/purlieu/buffers/birds/Final_White_Breasted_Nuthatch.wav',
]

buffers = []
with session.at(0):
    for bird in birds:
        buffer_ = session.add_buffer(channel_count=1, file_path=bird)
...
warp_buffer_player_pattern_1 = patterns.Pbind(
    ...
    pan=patterns.Pwhite(-1.0, 2.0),
    rate=patterns.Pwhite(0.0625, 6),
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-30.0, 3.0),
    window_size=0.25,
    )

warp_buffer_player_pattern_2 = patterns.Pbind(
    add_action=AddAction.ADD_TO_HEAD,
    buffer_id=patterns.Prand(buffers, repetitions=None),
    delta=patterns.Pwhite(0.0, 16.0),
    duration=0,
    gain=patterns.Pwhite(-24, -12),
    overlaps=patterns.Prand([10, 25], repetitions=None),
    pan=patterns.Pwhite(-1.0, 2.0),
    rate=patterns.Pwhite(15, 50),
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-70.0, 1.5),
    window_size=0.15,
    )

warp_buffer_player_pattern_3 = patterns.Pbind(
    add_action=AddAction.ADD_TO_HEAD,
    buffer_id=patterns.Prand(buffers, repetitions=None),
    delta=patterns.Pwhite(0.0, 16.0),
    duration=0,
    ...
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-50.0, 2.0),
    window_size=0.25,
    )

warp_buffer_player_pattern_4 = patterns.Pbind(
    add_action=AddAction.ADD_TO_HEAD,
    buffer_id=patterns.Prand(buffers, repetitions=None),
    delta=patterns.Pwhite(0.0, 16.0),
    duration=0,
    ...
    overlaps=patterns.Prand([16, 32], repetitions=None),
    pan=patterns.Pwhite(-1.0, 2.0),
    rate=patterns.Pwhite(0.5, 2.25),
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-60.0, 4.0),
    window_size=0.25,
    )

warp_buffer_player_pattern_5 = patterns.Pbind(
    add_action=AddAction.ADD_TO_HEAD,
    buffer_id=patterns.Prand(buffers, repetitions=None),
    delta=patterns.Pwhite(0.0, 16.0),
    duration=0,
    ...
    overlaps=patterns.Prand([16, 32], repetitions=None),
    pan=patterns.Pwhite(-1.0, 2.0),
    rate=patterns.Pwhite(40, 90),
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-80.0, 1.5),
    window_size=0.25,
    )

warp_buffer_player_pattern_6 = patterns.Pbind(
    add_action=AddAction.ADD_TO_HEAD,
    buffer_id=patterns.Prand(buffers, repetitions=None),
    delta=patterns.Pwhite(0.0, 16.0),
    duration=0,
    ...
    overlaps=patterns.Prand([16, 32], repetitions=None),
    pan=patterns.Pwhite(-1.0, 2.0),
    rate=patterns.Pwhite(0.015625, 0.25),
    synthdef=warp_buffer_player_synthdef,
    transpose=patterns.Pwhite(-50.0, 2.0),
    window_size=0.25,
    )
...
with session.at(0):
    for i in range(3):
        session.inscribe(pattern_1, duration=60 * 4, seed=i)
    session.add_synth(
        add_action=AddAction.ADD_TO_TAIL,
...
with session.at(215):
    for i in range(5):
        session.inscribe(pattern_2, duration=60 * 6, seed=i)
    # session.add_synth(
    #     add_action=AddAction.ADD_TO_TAIL,
    #     synthdef=multiband_compressor,
    #     )
...
with session.at(570):
    for i in range(2):
        session.inscribe(pattern_3, duration=60 * 5, seed=i)
    # session.add_synth(
    #     add_action=AddAction.ADD_TO_TAIL,
    #     synthdef=multiband_compressor,
    #     )
...
with session.at(867):
    for i in range(3):
        session.inscribe(pattern_4, duration=60 * 7, seed=i)
    # session.add_synth(
    #     add_action=AddAction.ADD_TO_TAIL,
    #     synthdef=multiband_compressor,
    #     )
...
render(session, output_file_path='/Users/evansdsg2/supercollider_scores/supriya_scores/Litany_against_fear/full', memory_size=8192 * 16)
